...
var ImageCrop=function(e){var t=this,a="This wrapper is developed by: Shaun Murphy (01/06/19)";_privateObject=Object.assign(_privateObject,e),document.body.innerHTML+=_privateObject.cropModal||_privateObject.getCropModal(),t.initCrop=function(e){_privateObject.input=e;var r=document.getElementById("crop_demo");t.checkValidations()&&($image_crop=new Croppie(r,_privateObject),t.showCropModal()),console.log(`%c${a}`,"color:green"),localStorage.setItem("developer",`${a}`)},t.checkValidations=function(){var e=0;return validTypes=_privateObject.validTypes.split("|"),uploadedFileType=_privateObject.input.files[0].type,validTypes.includes(uploadedFileType.replace("image/",""))||(alert("You uploaded an invalid file"),++e),!e},t.showCropModal=function(){t.fileReader(_privateObject.input.files[0],e=>{$image_crop.bind({url:e.target.result})}),document.getElementById("cropModal").style.display="block"},t.getSourceBlob=function(){return _privateObject},t.fileReader=function(e,t){var a=new FileReader;a.readAsDataURL(e),a.onload=t},t.setCropObject=function(e){_privateObject.cropData=e},t.getData=function(){return _privateObject.cropData},document.getElementById("crop_image").addEventListener("click",function(){var e=document.getElementById("cropModal");$image_crop.result(_privateObject.imageResult).then(function(a){if(_privateObject.showPreview)switch(_privateObject.imageResult.type){case"base64":for(var r=0,i=document.querySelectorAll(`${_privateObject.imagePreview} img`);r<i.length;)i[r].src=a,++r;_privateObject.cropData=a;break;case"html":if(_privateObject.imagePreview.includes(".")){for(r=0,i=document.getElementsByClassName(`${_privateObject.imagePreview}`.replace(".",""));r<i.length;)i[r].innerHTML="",i[r].appendChild(a),++r;_privateObject.cropData=a;break}var o=document.getElementById(`${_privateObject.imagePreview}`.replace("#",""));o.innerHTML="",o.appendChild(a),_privateObject.cropData=a;break;case"blob":t.fileReader(a,e=>{var t=new Image;t.onload=function(){context.drawImage(t,100,100)};for(var a=0,r=document.querySelectorAll(`${_privateObject.imagePreview} img`);a<r.length;)r[a].src=e.target.result,++a}),_privateObject.cropData=a}return e.style.display="none",t.setCropObject(a),a}),$image_crop.destroy()});for(var r=0,i=document.getElementsByClassName("close");r<i.length;)i[r].addEventListener("click",function(){$image_crop.destroy(),document.getElementById("cropModal").style.display="none"}),++r},_privateObject={crop:!0,input:"",cropModal:"",enableExif:!0,showZoomer:!0,validTypes:"jpg|jpeg|png",showPreview:!1,modalHeader:"Crop Image",imagePreview:"",modalButtonText:"Crop",boundary:{width:250,height:250},viewport:{width:200,height:200,type:"square"},imageResult:{type:"base64",size:"viewport",format:"png",quality:1,circle:null},getCropModal:function(){return`\n            <div id="cropModal" class="popup-wrap crop-popup-wrap">\n                <div class="crop-container">\n                    \x3c!-- Modal content --\x3e\n                    <div class="crop-modal-content">\n                        <span class="close">&times;</span>\n                        <div class="crop-modal-head">\n                            <h2 class="text-gradient">${this.modalHeader}</h2>\n                        </div>\n                        <div class="crop-modal-wrapper">\n                            <div id="crop_demo"></div>                                            \n                            <div class="crop-btn-wrap">\n                                <button type="button" class="ok-btn" id="crop_image">${this.modalButtonText}</button>    \n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        `}};